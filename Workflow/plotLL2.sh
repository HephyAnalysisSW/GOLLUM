#python plotLL2.py --postfix v7 --config configs/config_reference_v2.yaml --logLevel DEBUG --asimov_mu=2.5 --var mu         --range 2.78 2.82 0.002
#python plotLL2.py --postfix v7 --config configs/config_reference_v2.yaml --logLevel DEBUG --asimov_mu=2.5 --var nu_bkg     --range -0.1 0.1 0.002
#python plotLL2.py --postfix v7 --config configs/config_reference_v2.yaml --logLevel DEBUG --asimov_mu=2.5 --var nu_tt      --range -0.1 0.1 0.002
#python plotLL2.py --postfix v7 --config configs/config_reference_v2.yaml --logLevel DEBUG --asimov_mu=2.5 --var nu_diboson --range -0.1 0.1 0.002
#python plotLL2.py --postfix v7 --config configs/config_reference_v2.yaml --logLevel DEBUG --asimov_mu=2.5 --var nu_tes     --range -0.1 0.1 0.002
#python plotLL2.py --postfix v7 --config configs/config_reference_v2.yaml --logLevel DEBUG --asimov_mu=2.5 --var nu_jes     --range -0.1 0.1 0.002
#python plotLL2.py --postfix v7 --config configs/config_reference_v2.yaml --logLevel DEBUG --asimov_mu=2.5 --var nu_met     --range 0 0.1 0.002


#python plotLL2.py --postfix v3 --config configs/config_reference_v2.yaml --logLevel DEBUG --asimov_mu=2.5 --var nu_tt      --range -0.08 0.08 0.005



#python plotLL2.py --config config_reference_xgbmc.yaml --logLevel DEBUG --asimov_mu=2.5 --var mu         --range 2.0 2.6 0.01
#python plotLL2.py --config config_reference_xgbmc.yaml --logLevel DEBUG --asimov_mu=2.5 --var nu_bkg     --range -0.5 0.5 0.01
#python plotLL2.py --config config_reference_xgbmc.yaml --logLevel DEBUG --asimov_mu=2.5 --var nu_tt      --range -0.5 0.5 0.01
#python plotLL2.py --config config_reference_xgbmc.yaml --logLevel DEBUG --asimov_mu=2.5 --var nu_diboson --range -0.5 0.5 0.01
#python plotLL2.py --config config_reference_xgbmc.yaml --logLevel DEBUG --asimov_mu=2.5 --var nu_tes     --range -0.5 0.5 0.01
