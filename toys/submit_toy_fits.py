"""
Usage: python3 toys/submit_toy_fits.py 
...
config = "toys/fit_toys.py configs/unbinned_v5D/unbinned_delphes_6_RunII.yaml"
...
for i in range(len(toys)):
    ...
    full_command = f'sbatch toys/sh/submit_to_cpu_short.sh "{command}"'
    # print(full_command)
    # exit()
