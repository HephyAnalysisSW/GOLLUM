...
python plot_systematics.py  --config pnn_quad_met_v2 --selection lowMT_VBFJet
python plot_systematics.py  --config pnn_quad_met_v2 --selection highMT_VBFJet
python plot_systematics.py  --config pnn_quad_met_v2 --selection lowMT_noVBFJet_ptH0to100
python plot_systematics.py  --config pnn_quad_met_v2 --selection lowMT_noVBFJet_ptH100
python plot_systematics.py  --config pnn_quad_met_v2 --selection highMT_noVBFJet_ptH0to100
python plot_systematics.py  --config pnn_quad_met_v2 --selection highMT_noVBFJet_ptH100
