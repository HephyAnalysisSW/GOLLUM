...
if __name__=="__main__":
    ...
    parser.add_argument("--multiclass", action="store_true", default=False, help="If set, do multiclass calibration instead of 0 vs rest.")
    ...
    filename = os.path.join( model_directory, f'calibrator{"_multi" if args.multiclass else ""}.pkl')
