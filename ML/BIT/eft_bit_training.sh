...
submit --memory 35 --title bit --walltime 02-00:00:00 --queue medium  "python /users/ricardo.barrue/nsbi_gluon_pdf/GOLLUM/ML/BIT/eft_bit_training.py configs/unbinned_v7_eft/bit_training/unbinned_2016_eft.yaml --every 0 --job bit_TT01j2l_EFT_2016_ML4EFTWC" --output=eft_bit_training_15072026/

submit --memory 35 --title bit --walltime 02-00:00:00 --queue medium  "python /users/ricardo.barrue/nsbi_gluon_pdf/GOLLUM/ML/BIT/eft_bit_training.py configs/unbinned_v7_eft/bit_training/unbinned_2016_eft.yaml --every 0 --job bit_TT01j2l_EFT_2016_nonML4EFTWC" --output=eft_bit_training_15072026/
...
submit --memory 35 --title bit --walltime 02-00:00:00 --queue medium  "python /users/ricardo.barrue/nsbi_gluon_pdf/GOLLUM/ML/BIT/eft_bit_training.py configs/unbinned_v7_eft/bit_training/unbinned_2016_eft_ND.yaml --every 0 --job bit_TT01j2l_EFT_2016_allWC" --output=eft_bit_training_15072026/

submit --memory 35 --title bit --walltime 02-00:00:00 --queue medium  "python /users/ricardo.barrue/nsbi_gluon_pdf/GOLLUM/ML/BIT/eft_bit_training.py configs/unbinned_v7_eft/bit_training/unbinned_2016_eft_ND.yaml --every 0 --job bit_TT01j2l_EFT_2016_ML4EFTWC" --output=eft_bit_training_15072026/

submit --memory 35 --title bit --walltime 02-00:00:00 --queue medium  "python /users/ricardo.barrue/nsbi_gluon_pdf/GOLLUM/ML/BIT/eft_bit_training.py configs/unbinned_v7_eft/bit_training/unbinned_2016_eft_ND.yaml --every 0 --job bit_TT01j2l_EFT_2016_nonML4EFTWC" --output=eft_bit_training_15072026/
