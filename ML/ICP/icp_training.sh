python icp_training.py ../../configs/merged_no_reg.yaml --overwrite --job icp_tt2l_Trigger
python icp_training.py ../../configs/merged_no_reg.yaml --overwrite --job icp_tt2l_L1Prefire
python icp_training.py ../../configs/merged_no_reg.yaml --overwrite --job icp_tt2l_PU
python icp_training.py ../../configs/merged_no_reg.yaml --overwrite --job icp_tt2l_LeptonSF
...
python icp_training.py ../../configs/split_no_reg.yaml --overwrite --job icp_tt2l_GG_PU
python icp_training.py ../../configs/split_no_reg.yaml --overwrite --job icp_tt2l_GG_LeptonSF
...
python icp_training.py ../../configs/split_no_reg.yaml --overwrite --job icp_tt2l_QG_LeptonSF
...
python icp_training.py ../../configs/split_no_reg.yaml --overwrite --job icp_tt2l_QQ_LeptonSF
